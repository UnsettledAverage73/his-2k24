# Remedi.ps1
# Description: Sets 'Windows Firewall: Domain: Logging: Log dropped packets' to 'Yes'.
...
try {
    ...
    Write-Host "SUCCESS: 'Windows Firewall: Domain: Logging: Log dropped packets' has been set to Yes." -ForegroundColor Green
} catch {
    Write-Host "ERROR: Failed to configure 'Windows Firewall: Domain: Logging: Log dropped packets'. $_" -ForegroundColor Red
}
