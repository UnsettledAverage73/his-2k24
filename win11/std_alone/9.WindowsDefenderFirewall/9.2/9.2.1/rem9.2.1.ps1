# Remedi.ps1
# Description: Sets 'Windows Firewall: Domain: Logging: Log successful connections' to 'Yes'.
...
try {
    ...
    Write-Host "SUCCESS: 'Windows Firewall: Domain: Logging: Log successful connections' has been set to Yes." -ForegroundColor Green
} catch {
    Write-Host "ERROR: Failed to configure 'Windows Firewall: Domain: Logging: Log successful connections'. $_" -ForegroundColor Red
}
