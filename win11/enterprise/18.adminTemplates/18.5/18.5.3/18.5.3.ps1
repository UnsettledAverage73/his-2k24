# Check.ps1 - Verify if IPv4 Source Routing Protection is set to Highest Protection
...
try {
    ...
    if ($currentValue -eq $expectedValue) {
        Write-Host "$title - Status: Compliant (IPv4 source routing is completely disabled)."
    } else {
