# Title: CIS Control 19.7.38.1 (L1) - Remediate 'Turn off Windows Copilot'

Write-Host "Remediating: CIS Control 19.7.38.1 (L1) - Turn off Windows Copilot"
...
if ($sidList) {
    foreach ($sid in $sidList) {
        ...
        Write-Host "Remediated for user SID $($sid.Name): 'Turn off Windows Copilot' is now set to Enabled." -ForegroundColor Green
    }
} else {
