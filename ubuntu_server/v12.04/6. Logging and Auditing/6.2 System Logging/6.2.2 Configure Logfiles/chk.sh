...
# Function to verify var log file permissions and ownership
var_log_chk() {
  echo -e "- Var log file permissions and ownership check:"
  local l_output2=""
...
# Run the var log permissions and ownership check
var_log_chk
