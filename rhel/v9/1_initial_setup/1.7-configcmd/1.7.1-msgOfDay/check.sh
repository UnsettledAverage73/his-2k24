...
echo "Checking MOTD files for system information..."
...
if [ "${#a_files[@]}" -gt 0 ]; then
    ...
    echo -e "- **No MOTD files with system information were found. Please verify this conforms to local site policy** -"
fi
